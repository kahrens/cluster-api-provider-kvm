...
// +kubebuilder:rbac:groups=kvm.cluster.x-k8s.io,resources=kvmclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kvm.cluster.x-k8s.io,resources=kvmclusters/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=kvm.cluster.x-k8s.io,resources=kvmclusters/finalizers,verbs=update
